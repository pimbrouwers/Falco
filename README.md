...
Falco is a toolkit for building functional-first, [fast](#benchmarks) and fault-tolerant web applications using F#. Built upon the high-performance components of ASP.NET Core, rooted in an ethos of low-friction web programming **free** of "magic". 
