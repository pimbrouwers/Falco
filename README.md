...
Falco is a toolkit for building functional-first, fast and fault-tolerant web applications using F#. Rooted in an ethos of programming that is **free** of 🌟magic🌟. Built upon the high-performance components of ASP.NET Core: [Kestrel][1] & [Endpoint Routing][3].
