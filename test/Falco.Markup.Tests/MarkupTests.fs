...
let ``Should produce valid svg`` () =
    ...
    let doc =
        Templates.svg (0, 0, 240, 80) [
            ...
            Elem.create "text" [ Attr.create "x" "20"; Attr.create "y" "35"; Attr.class' "small" ] [ Text.raw "My" ]
            Elem.create "text" [ Attr.create "x" "40"; Attr.create "y" "35"; Attr.class' "heavy" ] [ Text.raw "cat" ]
            Elem.create "text" [ Attr.create "x" "55"; Attr.create "y" "55"; Attr.class' "small" ] [ Text.raw "is" ]
            Elem.create "text" [ Attr.create "x" "65"; Attr.create "y" "55"; Attr.class' "Rrrrr" ] [ Text.raw "Grumpy!" ]
        ]
